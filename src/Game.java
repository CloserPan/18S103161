public class Game {
	...
	public Game(String type) {
		if (type.equals("1")) {
			gameBoard = new Board("1");// 参数1代表国际象棋
	...
	public void setNames(String name1, String name2) {
		this.getPlayer1().setPlayerName(name1);
		this.getPlayer1().setPlayerTurn(0);
		this.getPlayer2().setPlayerName(name2);
		this.getPlayer2().setPlayerTurn(1);
		gameBoard.player1 = name1;
		gameBoard.player2 = name2;
	}
